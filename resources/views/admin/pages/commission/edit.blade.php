                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group row">
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_1"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_1)}}"
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_2"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_2)}}"
                                            class="form-control input-money" required>
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_3"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_3)}}"
                                            class="form-control input-money" required>
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_4"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_4)}}"
                                            class="form-control input-money" required>
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_5"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_5)}}"
                                            class="form-control input-money" required>
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_6"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_6)}}"
                                            class="form-control input-money" required>
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_7"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_7)}}"
                                            class="form-control input-money" required>
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_8"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_8)}}"
                                            class="form-control input-money" required>
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_9"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_9)}}"
                                            class="form-control input-money" required>
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="commission_10"
                                            value="{{convertMoneyUSAtoBrazil($commission->commission_10)}}"
                                            class="form-control input-money" required>
                                        <span class="input-group-addon">%</span>
                                    </div>
                                </div>
